        ...
        <div className="prose prose-gray max-w-none space-y-6">
          <section>
            ...
            <p className="text-gray-600 leading-relaxed">
              By accessing or using AI in Plain English ("Service"), you agree to be bound by these Terms of Service. If you do not agree to these terms, please do not use the Service.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-gray-600 leading-relaxed">
              AI in Plain English provides online educational courses with AI-powered tutoring, interactive lessons, quizzes, and progress tracking. Access to certain features requires a paid subscription.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-gray-600 leading-relaxed">
              All course content, materials, and platform design are the property of AI in Plain English or its content creators. You are granted a limited, non-exclusive, non-transferable license to access and use the content for personal educational purposes only.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-gray-600 leading-relaxed">
              The Service is provided "as is" without warranties of any kind. To the maximum extent permitted by law, AI in Plain English shall not be liable for any indirect, incidental, special, or consequential damages arising from your use of the Service.
            </p>
          </section>
